...
export const PostItem = ({post, isOwner, deleteAction}: IProps) => {
    ...
    return (
        <Link
            ...
            <div className={'flex w-full justify-between items-center gap-2 border-2 border-blue-100 rounded-xl p-6 bg-blue-50 mt-4 w-full hover:border-blue-300 hover:translate-y-1'}>
